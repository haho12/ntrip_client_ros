...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('host',                  default_value='www.openservice-sapos.niedersachsen.de'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='VRS_3_4G_NI'), # Valid! (Can be checked by changing to some other value.)
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='ni_HSHannover01'), # ?
