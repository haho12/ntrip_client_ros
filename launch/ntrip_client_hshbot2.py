...
def generate_launch_description():
      return LaunchDescription([
          # NTRIP Caster in Goettingen (does not accept NMEA position input)
          DeclareLaunchArgument('host',                  default_value='euref-ip.net'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='GOET00DEU0'), # Valid! (Can be checked by changing to some other value.)
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='homann'),
